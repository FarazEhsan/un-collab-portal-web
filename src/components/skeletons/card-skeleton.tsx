...
const CardSkeleton = () => {
    return (
        <div role="status"
             className="xl:mx-32 p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700">
            <div
            ...
            <div
                className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5"></div>
            <div
                className="h-2 bg-gray-200 rounded-full dark:bg-gray-700"></div>
            <div className="flex items-center mt-4">
                <svg className="w-10 h-10 me-3 text-gray-200 dark:text-gray-700"
                     aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <div>
                    ...
                    <div
                        className="w-48 h-2 bg-gray-200 rounded-full dark:bg-gray-700"></div>
                </div>
            </div>
