...
const CommentSection = ({ comments, commentsCount = 0, limitComments = false }:any) => {
    ...
    return (
        <div>
            ...
            {
                commentsCount === 0 ? (
                    <p className="text-base leading-6 text-gray-500 dark:text-gray-200">No comments yet.</p>
                    ...
                    <div>
                        ...
                        ))}
                        {
                            commentsCount > 3 && limitComments ? (
                                <p className="text-base leading-6 text-gray-500 dark:text-gray-200">Open topic to view all comments</p>
                            ) : (
                                ''
                            )
                        }
