...
const ProjectCard = () => {
    ...
    return (
        <div
            className="relative pt-6 dark:bg-gray-900 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-md dark:shadow-gray-950">

            <div
                className="absolute inset-0 flex items-start justify-end opacity-0 hover:opacity-100">
                <button
                    className="px-4 pt-1 text-custom-blue hover:text-custom-teal font-medium flex items-center">
