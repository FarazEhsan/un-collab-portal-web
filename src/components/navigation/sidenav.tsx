            ...
            <div>
                                        ...
                                        {navigation.map((item) => (
                                            <li key={item.name}>
                                                ...
                                                >
                                                    <item.icon
                                                        className={classNames(
                                                            item.current ? 'text-custom-teal dark:text-custom-orange' : 'text-gray-400 dark:text-gray-600 group-hover:text-custom-blue',
                                                            'h-6 w-6 shrink-0'
                                                        )}
                                                        aria-hidden="true"
                                                    />
                ...
                <div className="lg:pl-72">
                    <div
                      ...
                      <ChevronDownIcon className="ml-2 h-5 w-5 text-gray-400 dark:text-gray-600"
                                       aria-hidden="true"/>
                    </span>
                                    </Menu.Button>
                                    <Transition
