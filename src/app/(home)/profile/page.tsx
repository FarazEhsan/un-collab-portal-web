                    ...
                    <div
                        ...
                        <div>
                            <div className="flex flex-col items-center">
                                ...
                                <p
                                    className="text-gray-900 dark:text-gray-100">{data?.user?.userName}
                                </p>
                                <div className="mt-2">
                                    {
                                        data?.user?.facebook && (
                        ...
                        <div>
                            ...
                            <dl className="mt-4 space-y-6 divide-y divide-gray-100 dark:divide-gray-800 border-t border-gray-200 dark:border-gray-700 text-sm leading-6">
                                ...
                                <div className="pt-6 sm:flex">
                                    ...
                                    <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                                        <div
                                            className="text-gray-900 dark:text-gray-100">{data?.user?.city}
                                        </div>
                                    </dd>
                                </div>
                                <div className="pt-6 sm:flex">
                                    ...
                                    <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                                        <div
                                            className="text-gray-900 dark:text-gray-100">{data?.user?.country}
                                        </div>
                                    </dd>
                                </div>
                                <div className="pt-6 sm:flex">
                                    ...
                                    <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                                        <div
                                            className="text-gray-900 dark:text-gray-100">{data?.user?.age}
                                        </div>
                                    </dd>
                                </div>
                                {/*<div className="pt-6 sm:flex">*/}
                        ...
                        <div>
                            ...
                            <dl className="mt-4 space-y-6 divide-y divide-gray-100 dark:divide-gray-800 border-t border-gray-200 dark:border-gray-700 text-sm leading-6">
                                <div className="pt-6 sm:flex">
                                    ...
                                    <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                                        <div
                                            className="text-gray-900 dark:text-gray-100">{data?.user?.email}
                                        </div>
                                    </dd>
                                </div>
                                <div className="pt-6 sm:flex">
                                    ...
                                    <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                                        <div
                                            className="text-gray-900 dark:text-gray-100">{data?.user?.contactNumber}
                                        </div>
                                    </dd>
                                </div>
                            </dl>
