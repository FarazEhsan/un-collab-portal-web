        ...
        <div className="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
          <div>
            <div className="flex flex-col items-center">
              ...
              <div className="mt-2">
                {data?.user?.facebook && (
                  <RoundButton classNames="mx-1 bg-[#0866ff] hover:bg-[#478cfc]"  profileURL={data?.user?.facebook}>
                    {/*Facebook*/}
                    <svg
                ...
                {data?.user?.instagram && (
                  <RoundButton classNames="mx-1 bg-[#d62976] hover:bg-[#cf4e87]" profileURL={data?.user?.instagram}>
                    {/*Instagram*/}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-4 w-4"
                ...
                {data?.user?.linkedin && (
                  <RoundButton classNames="mx-1 bg-[#0077b5] hover:bg-[#3d8ab3] " profileURL={data?.user?.linkedin}>
                    {/*Linkedin*/}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-4 w-4"
                ...
                {data?.user?.tiktok && (
                  <RoundButton classNames="mx-1 bg-[#000] hover:bg-[#4f4e4e]" profileURL={data?.user?.tiktok}>
                    {/*Tiktok*/}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                ...
                {data?.user?.twitter && (
                  <RoundButton classNames="mx-1 bg-[#000] hover:bg-[#4f4e4e]" profileURL={data?.user?.twitter} >
                    {/*Twitter*/}
                    <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 448 512">
