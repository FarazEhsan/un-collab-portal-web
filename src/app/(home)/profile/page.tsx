        ...
        <SingleColumnContainer>
            <div
                ...
                <div>
                    <div className="flex flex-col items-center">
                        ...
                        <div className="mt-2">
                            ...
                            <RoundButton
                                classNames="mx-1 bg-[#1DA1F2] hover:bg-[#6bc4fa]">
                                {/*Twitter*/}
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-4 w-4"
                            ...
                            <RoundButton
                                classNames="mx-1 bg-[#25d366] hover:bg-[#69cf8f]">
                                {/*Whatsapp*/}
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-4 w-4"
                ...
                <div>
                    ...
                    <dl className="mt-4 space-y-6 divide-y divide-gray-100 dark:divide-gray-800 border-t border-gray-200 dark:border-gray-700 text-sm leading-6">
                        ...
                        <div className="pt-6 sm:flex">
                            ...
                            <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                                <div
                                    className="text-gray-900 dark:text-gray-100">California
                                </div>
                            </dd>
                        </div>
                        <div className="pt-6 sm:flex">
                            ...
                            <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                                <div
                                    className="text-gray-900 dark:text-gray-100">USA
                                </div>
                            </dd>
                        </div>
                        <div className="pt-6 sm:flex">
                            ...
                            <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                                <div
                                    className="text-gray-900 dark:text-gray-100">50
                                </div>
                            </dd>
                        </div>
                        {/*<div className="pt-6 sm:flex">*/}
                ...
                <div>
                    ...
                    <dl className="mt-4 space-y-6 divide-y divide-gray-100 dark:divide-gray-800 border-t border-gray-200 dark:border-gray-700 text-sm leading-6">
                        <div className="pt-6 sm:flex">
                            ...
                            <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                                <div
                                    className="text-gray-900 dark:text-gray-100">tom.cook@example.com
                                </div>
                            </dd>
                        </div>
                        <div className="pt-6 sm:flex">
                            ...
                            <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                                <div
                                    className="text-gray-900 dark:text-gray-100">0123456778
                                </div>
                            </dd>
                        </div>
                    </dl>
                ...
                <div>
                    ...
                    <dl className="mt-4 space-y-6 divide-y divide-gray-100 dark:divide-gray-800 border-t border-gray-200 dark:border-gray-700 text-sm leading-6">
                        <div className="pt-6 sm:flex">
                            <dt className="font-medium text-gray-900 dark:text-gray-100 sm:w-64 sm:flex-none sm:pr-6">Primary
                                Groups
                            </dt>
                            <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                                <ul>
                                    <li className="text-gray-900 dark:text-gray-100">Youth
                                        Advisory Board
                                    </li>
                                    <li className="text-gray-900 dark:text-gray-100">Youth
                                        2030 Cities Alumni
                                    </li>
                                    <li className="text-gray-900 dark:text-gray-100">Young
                                        Gamechangers
                                    </li>
                                </ul>
                            </dd>
            ...
            <EditPersonalInfoSlideOver open={openEditPersonalInfoSlideOver}
                                       setOpen={setOpenEditPersonalInfoSlideOver}/>
            <EditContactInfoSlideOver open={openEditContactInfoSlideOver}
