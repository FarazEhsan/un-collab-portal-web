        ...
        <>
            <main className="grid min-h-full place-items-center bg-white dark:bg-gray-950 px-6 py-24 sm:py-32 lg:px-8">
                <div className="text-center">
                    <p className="text-base font-semibold text-custom-blue">403</p>
                    <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-5xl">Forbidden</h1>
